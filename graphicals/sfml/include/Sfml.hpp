...
namespace Arcade
{
    class Sfml : public IGraphicals {
        public:
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            /// @brief Create a SfText by a string, a size and positions
            /// @warning Warning Sirrr
            /// @param str String that will be transformed in SfText
            /// @param size Size of the text
            /// @param x X coordinate of the new position
            /// @param y Y coordinate of the new position
            ///
            sf::Text getText(const std::string str, int size, int x, int y);
            ...
            ///
            int checkPosition(sf::Text text);
            ...
            /// @param text The Sf::Text
            ///
            int checkRectPosition(sf::RectangleShape);
            ...
            void checkChoices(std::map<int, sf::Text> &_gameText, std::map<int, sf::Text> &_libText);

            void enterUsername(int g);

            void pauseIn();

            int checkClick(sf::Text &_pause);
        ...
        private:
            ...
            sf::Font _font;
            std::map<int, void (Arcade::Sfml::*)()> _sceneFunc;
            std::map<int, void (Arcade::Sfml::*)()> _menuFunc;
            std::array<sf::Text, 4> _menuText = {getText("PLAY", 20, 100, 284), getText("HOW TO PLAY", 20, 100, 324), getText("SETTINGS", 20, 100, 364), getText("QUIT", 20, 100, 408)};
    };
}